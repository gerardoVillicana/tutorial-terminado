export let calculateMonthlyPayment = function calculateMonthlyPayment(principal, years, rate) {
    var monthlyRate = 0;
    if (rate) {
...
export let calculateAmortization = function calculateAmortization(principal, years, rate) {
